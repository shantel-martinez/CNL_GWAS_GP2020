...
```{r}
myGM<-read.csv("./myGM.csv", head = TRUE,na.string=c(""," ","NA","na","NaN"))
myGM$X <- NULL
...
N1 <- length(white0$P.value) #this is the length of your gwas pvalues which is = your marker No.
expected <- sort( (-log10( c(1:N1) * (1/N1) ) )+2) #this like uniform distribution
observed <- sort( -(log10(white0$P.value))) #the df with the -log10(p) values
...
N1 <- length(red4$P.value) #this is the length of your gwas pvalues which is = your marker No.
expected <- sort( (-log10( c(1:N1) * (1/N1) ) )+2) #this like uniform distribution
observed <- sort( -(log10(red4$P.value))) #the df with the -log10(p) values
...
N1 <- length(red0$P.value) #this is the length of your gwas pvalues which is = your marker No.
expected <- sort( (-log10( c(1:N1) * (1/N1) ) )+2) #this like uniform distribution
observed <- sort( -(log10(red0$P.value))) #the df with the -log10(p) values
